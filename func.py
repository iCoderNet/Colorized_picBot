...
def picGray(input_img, output_img):
    try:
        img = Image.open(input_img)
        img = img.convert("L")
        img.save(output_img)
        
        return {'status': "ok", "output": output_img}
    except:
        return {'status': "error", }



def colorized(input_img, output_img):
    try:
        # Path of our caffemodel, prototxt, and numpy files
        prototxt = "/home/uzbpromax/TST/H/Model/colorization_deploy_v2.prototxt"
        caffe_model = "/home/uzbpromax/TST/H/Model/colorization_release_v2.caffemodel"
        pts_npy = "/home/uzbpromax/TST/H/Model/pts_in_hull.npy"
        ...
        test_image = cv2.imread(input_img)
        ...
        cv2.imwrite(output_img, RGB_BGR)
